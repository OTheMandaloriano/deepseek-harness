...
/** Brazilian Portuguese dictionary for models settings section. */
export const ptBR: Record<keyof typeof en, string> = {
  nav: 'Modelos',
  title: 'Modelos',
  intro: 'Insira suas chaves de API para usar modelos dos seguintes provedores.',
  edit: 'Editar',
  editProvider: 'Editar {provider}',
  remove: 'Excluir',
  removeProvider: 'Excluir {provider}',
  deleteTitle: 'Excluir {provider}?',
  deleteDescription: 'A exclusão de {provider} remove sua configuração. Quaisquer credenciais utilizadas são gerenciadas separadamente e serão mantidas.',
  deleteDescriptionWithCredential: 'A exclusão de {provider} remove sua configuração e a chave de API armazenada.',
  ...
  apply: 'Aplicar',
  applying: 'Aplicando…',
  savedProvider: '{provider} salvo com sucesso.',
  ...
  conflict: 'Outra pessoa alterou estas configurações enquanto este painel estava aberto. Feche-o e reabra para editar os valores atuais.',
  retry: 'Tentar novamente',
  keyInput: 'Chave de API',
  keyPlaceholder: 'Insira sua chave de API',
  keyPlaceholderNative: 'Insira uma chave de API ou deixe em branco para autenticação via variáveis de ambiente',
  ...
  models: 'Modelos',
  modelsInherited: 'Usando padrões do adaptador',
  ...
  keyBlank: 'Insira a chave de API ou deixe o campo vazio para manter a armazenada.',
  keyBlankNew: 'Insira a chave de API ou deixe o campo vazio se este provedor autenticar por outro método.',
  keyIllegalCharacters: 'Esta chave de API não está em um formato válido. Por favor, verifique.',
  ...
  modelMaxTokensInvalid: 'O limite de tokens de saída deve ser um número positivo, como 8192, 64K ou 1M.',
  ...
  fetching: 'Consultando provedor…',
  fetchNeedsBaseUrl: 'Informe a URL Base primeiro antes de buscar.',
  fetchEmpty: 'O provedor não listou nenhum modelo. Adicione-os manualmente.',
  fetchTitle: 'Escolher modelos para adicionar',
  fetchDescription: 'Estes são os modelos disponibilizados pelo provedor. Escolha quais deseja adicionar.',
  fetchSearch: 'Buscar modelos',
  fetchNoMatches: 'Nenhum modelo correspondente encontrado.',
  ...
  customRouteHint: 'Identificador em minúsculas, iniciando com letra, que identifica unicamente este provedor em requisições e como nome da credencial.',
  customRouteInvalid: 'Comece com uma letra minúscula; em seguida utilize letras minúsculas, dígitos e hífens.',
  customRouteTaken: 'Um provedor já está utilizando este ID.',
  customDisplayName: 'Nome de exibição',
  customApi: 'Protocolo de API',
  customApiUnset: 'Não selecionado',
  customNeedsBaseUrl: 'Um provedor personalizado requer uma URL Base.',
  ...
  creating: 'Criando…',
  welcomeTitle: 'Aviso de Testes Internos',
  welcomeBody: 'O DeepSeek Harness 0.1 permanece em fase de testes para desenvolvedores do Harness. Muitas áreas ainda necessitam de melhorias, e agradecemos o feedback da comunidade de desenvolvedores. Os plugins principais e as APIs fundamentais do DeepSeek Harness continuarão evoluindo rapidamente nos próximos meses.\n\nEsperamos explorar os limites da inteligência com desenvolvedores de todo o mundo, construindo sobre uma infraestrutura de código aberto, aberta, reutilizável e combinável. Damos as boas-vindas aos desenvolvedores do Harness de todos os lugares para se juntarem ao ecossistema de plugins do DSH.',
  welcomeContinue: 'Continuar',
  welcomeError: 'Não foi possível salvar a confirmação. Por favor, tente novamente.',
  onboardingTitle: 'Adicione uma chave de API para começar',
  onboardingDescription: 'Configure o provedor oficial da DeepSeek para começar a criar.',
