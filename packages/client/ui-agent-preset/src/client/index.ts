...
import { en, zh, type AgentPresetSettingsKey, ptBR } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register('settings.agentPreset', { zh, en, 'pt-BR': ptBR }), 'ui-agent-preset: settings row dictionaries')
