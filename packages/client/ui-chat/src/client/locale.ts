...
/** Brazilian Portuguese dictionary for chat. */
export const ptBR = {
  ...en,
  'view.chat': 'Chat',
  'number.groupSeparator': '.',
  ...
  'stats.cacheHit': 'Taxa de acerto em cache {percent}%',
  'stats.dialog.title': 'Estatísticas da sessão',
  'stats.dialog.usageTitle': 'Uso de tokens',
  'stats.dialog.llmTime': 'Tempo de resposta do modelo',
  'stats.dialog.toolTime': 'Tempo de execução de ferramentas',
  'stats.dialog.ttft': 'Tempo até o primeiro token (TTFT)',
  'stats.dialog.speed': 'Velocidade de geração (TPS)',
  ...
  'chat.toBottom': 'Rolar para o final',
  'chat.deepDiving': 'Análise profunda em andamento...',
  ...
  'settings.transcript.description': 'Controla o conteúdo do processo em etapas concluídas',
  'settings.transcript.normal': 'Completa',
  'settings.transcript.compact': 'Compacta',
  'fileOpen.title': 'Não foi possível abrir o arquivo',
  'fileOpen.unknown': 'Não foi possível abrir este tipo de arquivo',
} satisfies Record<ChatKey, string>
