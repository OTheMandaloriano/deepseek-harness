...
/** Brazilian Portuguese copy for plugin settings. */
export const ptBR: Record<PluginsSettingsLocaleKey, string> = {
  nav: 'Plugins',
  title: 'Plugins',
  intro: 'Configure e inspecione os plugins instalados nesta implantação.',
  tabs: 'Visualização de plugins',
  configurableTab: 'Configuração de plugins',
  empty: 'Nenhuma configuração de plugin aberta nesta implantação.',
  overridden: 'Substituído',
  reset: 'Restaurar padrão',
  readOnly: 'As configurações desta implantação são somente leitura.',
  expand: 'Expandir configurações',
  collapse: 'Recolher configurações',
  save: 'Salvar',
  saving: 'Salvando…',
  discard: 'Descartar',
  unsaved: 'Não salvo',
  saveFailed: 'Esta implantação não aceitou estes valores. Eles foram mantidos para você editar.',
  invalidNumber: 'Por favor, informe um número; deixe em branco para usar o padrão.',
  ...
  bashTimeoutMsHint: 'Tempo máximo que um comando pode executar antes de ser encerrado.',
  bashMaxOutputBytes: 'Limite de saída por fluxo (bytes)',
  bashMaxOutputBytesHint: 'Saídas que ultrapassarem este limite serão salvas em arquivo temporário em vez de serem perdidas.',
  agentLoopTitle: 'Ciclo do agente (Loop)',
  agentLoopDescription: 'Como o agente despacha as chamadas de ferramentas.',
  agentLoopMaxParallel: 'Chamadas paralelas de ferramentas',
  agentLoopMaxParallelHint: 'Limite máximo de chamadas seguras para execução paralela em um único passo.',
  ...
  webSearchApiKeySet: 'Uma chave de API está configurada.',
  webSearchApiKeyUnset: 'Nenhuma chave configurada; a pesquisa ficará indisponível até configurar uma.',
  webSearchBaseUrl: 'Endpoint',
  webSearchBaseUrlHint: 'Deixe em branco para usar o padrão do provedor.',
  webSearchMaxUses: 'Máximo de pesquisas por requisição',
  webSearchMaxUsesHint: 'Quantas vezes uma requisição pode realizar buscas antes de precisar responder.',
  ...
  subagentModelSelectionChoose: 'Quando habilitado, os agentes podem escolher o provedor, modelo e esforço de raciocínio para cada subagente a partir dos modelos autorizados abaixo. Aplica-se apenas a novas sessões.',
  ...
  subagentModelSelectionPartial: 'Alguns provedores de modelo não puderam ser carregados; escolhas salvas ainda podem ser removidas.',
  ...
  subagentModelSelectionEmpty: 'Nenhum provedor de modelo está disponível no momento.',
  subagentModelSelectionRequired: 'Selecione pelo menos um modelo antes de salvar.',
  subagentModelSelectionConflict: 'As configurações foram alteradas em outro local. Descarte suas alterações e tente novamente.',
  subagentModelSelectionOff: 'Os subagentes usam os padrões configurados ou herdam o modelo do agente pai. Escolhas de modelos salvas são mantidas.',
}
